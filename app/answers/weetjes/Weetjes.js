export const WEETJES_TRIGGER = ["weetje", "wistje"];
...
export const WEETJES_ANSWER = [
  ...
  "Wist je dat dat de meeste vrouwen het vaak kouder hebben dan mannen?",
  "Wist je dat dat een varken fysiek niet in staat is om naar de lucht te kijken?",
  "Wist je dat dat net zoals de vingerafdruk ook de tongafdruk bij ieder mens uniek is?",
  ...
  "Wist je dat de gemiddelde chauffeur 15.250 keer toeterd in zijn leven?",
  ...
  "Wist je dat de zandtijgerhaai zijn broers en zussen op eet voordat hij geboren wordt?",
  ...
  "Wist je dat een meerval ruim 27000 smaakpapillen heeft?",
  ...
  "Wist je dat een vrouw gemiddeld 2 jaar van haar leven in een badkamer doorbengt?",
  ...
  "De zeester is het enige dier dat zijn maag binnneste buiten kan draaien",
  ...
  "Het woord ‘Yo-yo’ eigenlijk ‘come-come’ betekend",
  "Het langste woord dat met de linkerkant van het toestenbord gespeld kan worden is stewardess",
  "Het enige 15 letterwoord dat gespeld kan worden zonder dat je letters herhaald is ‘uncopyrightable’",
  "Het Hawaiiaanse alfabed heeft 12 letters",
  "Rubberen banden gaat langer mee als ze gekoeld zijn",
  ...
  "Net zoals vingerafdrukken is de tongafdruk identiek",
  ...
  "Wist je dat de grootse cactus ter wereld 25 meter hoog is ?",
  "Wist je dat honing meer dan 3000 jaar houdbaar blijft ?",
  "Wist je dat de gezichten die voorkomen in je dromen niet nieuw zijn ?",
  "Wist je dat vrouwen vaker knipperen ?",
  "Wist je dat je hart rond de 8000 tot 9000 liter bloed per dag rondpompt ?",
  "Wist je dat papiergeld voor het eerst in China werd gebruikt ?",
  "Wist je dat China maar liefst 124.000 kilometer treinrails heeft heeft ?",
  "Wist je dat een gemiddeld mens ongeveer 14 scheten per dag laat ?",
  "Wist je dat er elke dag meer dan 12 jaar aan beeldmateriaal word ge-upload op Youtube ?",
  "Wist je dat McDonalds elke seconde 75 hamburgers verkoopt ?",
  "Wist je dat 8% van de mannen kleurenblind is ?",
  "Wist je dat mannen vaker schade rijden dan vrouwen ?",
  "Wist je dat een mens gemiddeld 6000 scheten per jaar laat ?",
  "Wist je dat dieren ook humor hebben ?",
  "Wist je dat het woord 'van' de meeste betekenissen heeft ?",
  "Wist je dat er 0,3 procent van de Sahara nodig is om Europa te voorzien van stroom ?",
  ...
  "Wist je dat heet water sneller bevriest dan koud water ?",
  "Wist je dat Slechts 20 procent van de Sahara uit zand bestaat ?",
  "Wist je dat 57,7 graden de hoogste buitentemperatuur ooit gemeten is ?",
  "Wist je dat -89,2 °C de laagste buitentemperatuur ooit gemeten is ?",
  "Wist je dat de strepen van een zebra voor verkoeling zorgen ?",
  "Wist je dat de Kolibrie achteruit kan vliegen ?",
  "Wist je dat mensen met rood haar minder pijn voelen ?",
