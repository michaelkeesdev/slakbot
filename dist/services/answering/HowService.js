...
var HowService = /*#__PURE__*/_createClass(function HowService(mood, inputText, responseBuilder) {
  var _this = this;
  _classCallCheck(this, HowService);
  ...
  _defineProperty(this, "answer", function () {
    var noun = (0, _lodash.sample)(_RandomNouns.NOUNS);
    ...
    var answer = (0, _lodash.sample)(_How.HOW_ANSWER).replace(/%\w+%/g, function (all) {
      return how[all] || all;
    });
